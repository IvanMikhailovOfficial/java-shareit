...
@JsonTest
public class ItemRequestOutputDTOTest {
    @Autowired
    ...
    void testSerialize() {
        ...
        ItemRequestOutputDto itemRequestDto = ItemRequestOutputDto.builder()
                .id(1L)
                .created(created)
        ...
        JsonContent<ItemRequestOutputDto> result = json.write(itemRequestDto);
    ...
    void testDeserialize() {
        ...
        ItemRequestOutputDto object = json.parse(jsonContent).getObject();
