...
public class BookingClient extends BaseClient {
    private static final String API_PREF = "/bookings";

    @Autowired
    public BookingClient(@Value("${shareit-server.url}") String serverUrl, RestTemplateBuilder builder) {
        super(
                builder
                        .uriTemplateHandler(new DefaultUriBuilderFactory(serverUrl + API_PREF))
    ...
    public ResponseEntity<Object> readBookingById(Long userId, Long bookingId) {
